...
public class MetaData {
    ...
    public static final String RAT_LICENSE_FAMILY_CATEGORY_VALUE_MPL2 = "MPL2  ";
    public static final String RAT_LICENSE_FAMILY_CATEGORY_VALUE_MSPL = "MS-PL  ";
    public static final String RAT_LICENSE_FAMILY_CATEGORY_VALUE_PUBLIC_DOMAIN = "PUBLIC DOMAIN  ";
    public static final String RAT_LICENSE_FAMILY_CATEGORY_VALUE_EPL1 = "EPL1  ";
    public static final String RAT_LICENSE_FAMILY_CATEGORY_VALUE_AFL11 = "AFL1.1  ";
    public static final String RAT_LICENSE_FAMILY_CATEGORY_VALUE_AFL12 = "AFL1.2  ";
    public static final String RAT_LICENSE_FAMILY_CATEGORY_VALUE_AFL20 = "AFL2.0  ";
    public static final String RAT_LICENSE_FAMILY_CATEGORY_VALUE_AFL21 = "AFL2.1  ";
    public static final String RAT_LICENSE_FAMILY_CATEGORY_VALUE_AFL30 = "AFL3.0  ";
    public static final String RAT_LICENSE_FAMILY_CATEGORY_VALUE_CDDL1 = "CDDL1";
    public static final String RAT_LICENSE_FAMILY_CATEGORY_VALUE_LGPL21 ="LGPL2.1 ";
    public static final String RAT_LICENSE_FAMILY_CATEGORY_VALUE_LGPL3 ="LGPL3 ";
    public static final String RAT_LICENSE_FAMILY_CATEGORY_VALUE_AGPL3 ="AGPL3 ";
    public static final String RAT_LICENSE_FAMILY_CATEGORY_VALUE_BSD2 ="BSD2 ";
    public static final String RAT_LICENSE_FAMILY_CATEGORY_VALUE_BSD3 ="BSD3 ";
    public static final String RAT_LICENSE_FAMILY_CATEGORY_VALUE_BSD4 ="BSD4 ";
    public static final String RAT_LICENSE_FAMILY_CATEGORY_VALUE_APSL20 ="APSL20 ";
    public static final String RAT_LICENSE_FAMILY_CATEGORY_VALUE_ZLIB ="zlib ";
    ...
    public static final Datum RAT_LICENSE_FAMILY_CATEGORY_DATUM_MPL2 = new Datum(RAT_URL_LICENSE_FAMILY_CATEGORY,RAT_LICENSE_FAMILY_CATEGORY_VALUE_MPL2);
    public static final Datum RAT_LICENSE_FAMILY_CATEGORY_DATUM_MSPL = new Datum(RAT_URL_LICENSE_FAMILY_CATEGORY,RAT_LICENSE_FAMILY_CATEGORY_VALUE_MSPL);
    ...
    public static final Datum RAT_LICENSE_FAMILY_CATEGORY_DATUM_LGPL21 = new Datum(RAT_URL_LICENSE_FAMILY_CATEGORY, RAT_LICENSE_FAMILY_CATEGORY_VALUE_LGPL21);
    public static final Datum RAT_LICENSE_FAMILY_CATEGORY_DATUM_LGPL3 = new Datum(RAT_URL_LICENSE_FAMILY_CATEGORY, RAT_LICENSE_FAMILY_CATEGORY_VALUE_LGPL3);
    ...
    public static final Datum RAT_LICENSE_FAMILY_CATEGORY_DATUM_BSD2 = new Datum(RAT_URL_LICENSE_FAMILY_CATEGORY, RAT_LICENSE_FAMILY_CATEGORY_VALUE_BSD2);
    public static final Datum RAT_LICENSE_FAMILY_CATEGORY_DATUM_BSD3 = new Datum(RAT_URL_LICENSE_FAMILY_CATEGORY, RAT_LICENSE_FAMILY_CATEGORY_VALUE_BSD3);
    public static final Datum RAT_LICENSE_FAMILY_CATEGORY_DATUM_BSD4 = new Datum(RAT_URL_LICENSE_FAMILY_CATEGORY, RAT_LICENSE_FAMILY_CATEGORY_VALUE_BSD4);
    public static final Datum RAT_LICENSE_FAMILY_CATEGORY_DATUM_PUBLIC_DOMAIN = new Datum(RAT_URL_LICENSE_FAMILY_CATEGORY,RAT_LICENSE_FAMILY_CATEGORY_VALUE_PUBLIC_DOMAIN);
    public static final Datum RAT_LICENSE_FAMILY_CATEGORY_DATUM_EPL1 = new Datum(RAT_URL_LICENSE_FAMILY_CATEGORY,RAT_LICENSE_FAMILY_CATEGORY_VALUE_EPL1);
    public static final Datum RAT_LICENSE_FAMILY_CATEGORY_DATUM_AFL11 = new Datum(RAT_URL_LICENSE_FAMILY_CATEGORY,RAT_LICENSE_FAMILY_CATEGORY_VALUE_AFL11);
    public static final Datum RAT_LICENSE_FAMILY_CATEGORY_DATUM_AFL12 = new Datum(RAT_URL_LICENSE_FAMILY_CATEGORY,RAT_LICENSE_FAMILY_CATEGORY_VALUE_AFL12);
    public static final Datum RAT_LICENSE_FAMILY_CATEGORY_DATUM_AFL20 = new Datum(RAT_URL_LICENSE_FAMILY_CATEGORY,RAT_LICENSE_FAMILY_CATEGORY_VALUE_AFL20);
    public static final Datum RAT_LICENSE_FAMILY_CATEGORY_DATUM_AFL21 = new Datum(RAT_URL_LICENSE_FAMILY_CATEGORY,RAT_LICENSE_FAMILY_CATEGORY_VALUE_AFL21);
    public static final Datum RAT_LICENSE_FAMILY_CATEGORY_DATUM_AFL30 = new Datum(RAT_URL_LICENSE_FAMILY_CATEGORY,RAT_LICENSE_FAMILY_CATEGORY_VALUE_AFL30);
    public static final Datum RAT_LICENSE_FAMILY_CATEGORY_DATUM_APSL20 = new Datum(RAT_URL_LICENSE_FAMILY_CATEGORY, RAT_LICENSE_FAMILY_CATEGORY_VALUE_APSL20);
    public static final Datum RAT_LICENSE_FAMILY_CATEGORY_DATUM_ZLIB = new Datum(RAT_URL_LICENSE_FAMILY_CATEGORY, RAT_LICENSE_FAMILY_CATEGORY_VALUE_ZLIB);
    ...
    public static final String RAT_LICENSE_FAMILY_NAME_VALUE_LGPL_VERSION_2_1 = "GNU Lesser General Public License, Version 2.1";
    public static final String RAT_LICENSE_FAMILY_NAME_VALUE_LGPL_VERSION_3 = "GNU Lesser General Public License, Version 3";
    public static final String RAT_LICENSE_FAMILY_NAME_VALUE_AGPL_VERSION_3 = "GNU Affero General Public License, Version 3";
    public static final String RAT_LICENSE_FAMILY_NAME_VALUE_AFL_VERSION_1_1 = "Academic Free License version 1.1";
    public static final String RAT_LICENSE_FAMILY_NAME_VALUE_AFL_VERSION_1_2 = "Academic Free License version 1.2";
    public static final String RAT_LICENSE_FAMILY_NAME_VALUE_AFL_VERSION_2_0 = "Academic Free License version 2.0";
    public static final String RAT_LICENSE_FAMILY_NAME_VALUE_AFL_VERSION_2_1 = "Academic Free License version 2.1";
    public static final String RAT_LICENSE_FAMILY_NAME_VALUE_AFL_VERSION_3_0 = "Academic Free License version 3.0";
    public static final String RAT_LICENSE_FAMILY_NAME_VALUE_APSL_VERSION_2_0 = "APPLE PUBLIC SOURCE LICENSE Version 2.0";
    public static final String RAT_LICENSE_FAMILY_NAME_VALUE_BSD_VERSION_2 = "BSD, Version 2";
    public static final String RAT_LICENSE_FAMILY_NAME_VALUE_BSD_VERSION_3 = "BSD, Version 3";
    public static final String RAT_LICENSE_FAMILY_NAME_VALUE_BSD_VERSION_4 = "BSD, Version 4";
    ...
    public static final String RAT_LICENSE_FAMILY_NAME_VALUE_MPL2 = "Mozilla Public License 2.0";
    public static final String RAT_LICENSE_FAMILY_NAME_VALUE_MSPL = "Microsoft Public License";
    public static final String RAT_LICENSE_FAMILY_NAME_VALUE_PUBLIC_DOMAIN = "Public Domain";
    public static final String RAT_LICENSE_FAMILY_NAME_VALUE_EPL1 = "Eclipse Public License 1.0";
    public static final String RAT_LICENSE_FAMILY_NAME_VALUE_CDDL1 = "COMMON DEVELOPMENT AND DISTRIBUTION LICENSE Version 1.0";
    public static final String RAT_LICENSE_FAMILY_NAME_VALUE_ACADEMIC_FREE_LICENSE_VERSION_1_1 = "Academic Free License, Version 1.1";
    public static final String RAT_LICENSE_FAMILY_NAME_VALUE_ACADEMIC_FREE_LICENSE_VERSION_1_2 = "Academic Free License, Version 1.2";
    public static final String RAT_LICENSE_FAMILY_NAME_VALUE_ACADEMIC_FREE_LICENSE_VERSION_2_0 = "Academic Free License, Version 2.0";
    ...
    public static final String RAT_LICENSE_FAMILY_NAME_VALUE_ACADEMIC_FREE_LICENSE_VERSION_3_0 = "Academic Free License, Version 3.0";
    public static final String RAT_LICENSE_FAMILY_NAME_VALUE_ZLIB = "zlib License";
    ...
    public static final Datum RAT_LICENSE_FAMILY_NAME_DATUM_GPL_VERSION_1 = new Datum(RAT_URL_LICENSE_FAMILY_NAME, RAT_LICENSE_FAMILY_CATEGORY_VALUE_GPL1);
    public static final Datum RAT_LICENSE_FAMILY_NAME_DATUM_GPL_VERSION_2 = new Datum(RAT_URL_LICENSE_FAMILY_NAME, RAT_LICENSE_FAMILY_CATEGORY_VALUE_GPL2);
    ...
    public static final Datum RAT_LICENSE_FAMILY_NAME_DATUM_MPL2 = new Datum(RAT_URL_LICENSE_FAMILY_NAME, RAT_LICENSE_FAMILY_NAME_VALUE_MPL2);
    public static final Datum RAT_LICENSE_FAMILY_NAME_DATUM_MSPL = new Datum(RAT_URL_LICENSE_FAMILY_NAME, RAT_LICENSE_FAMILY_NAME_VALUE_MSPL);
    ...
    public static final Datum RAT_LICENSE_FAMILY_NAME_DATUM_UNKNOWN = new Datum(RAT_URL_LICENSE_FAMILY_NAME, RAT_LICENSE_FAMILY_NAME_VALUE_UNKNOWN);
    public static final Datum RAT_LICENSE_FAMILY_NAME_DATUM_LGPL_VERSION_2_1 = new Datum(RAT_URL_LICENSE_FAMILY_NAME, RAT_LICENSE_FAMILY_NAME_VALUE_LGPL_VERSION_2_1);
    public static final Datum RAT_LICENSE_FAMILY_NAME_DATUM_LGPL_VERSION_3 = new Datum(RAT_URL_LICENSE_FAMILY_NAME, RAT_LICENSE_FAMILY_NAME_VALUE_LGPL_VERSION_3);
    public static final Datum RAT_LICENSE_FAMILY_NAME_DATUM_AGPL_VERSION_3 = new Datum(RAT_URL_LICENSE_FAMILY_NAME, RAT_LICENSE_FAMILY_NAME_VALUE_AGPL_VERSION_3);
    public static final Datum RAT_LICENSE_FAMILY_NAME_DATUM_AFL_11 = new Datum(RAT_URL_LICENSE_FAMILY_NAME, RAT_LICENSE_FAMILY_NAME_VALUE_AFL_VERSION_1_1);
    public static final Datum RAT_LICENSE_FAMILY_NAME_DATUM_AFL_12 = new Datum(RAT_URL_LICENSE_FAMILY_NAME, RAT_LICENSE_FAMILY_NAME_VALUE_AFL_VERSION_1_2);
    public static final Datum RAT_LICENSE_FAMILY_NAME_DATUM_AFL_20 = new Datum(RAT_URL_LICENSE_FAMILY_NAME, RAT_LICENSE_FAMILY_NAME_VALUE_AFL_VERSION_2_0);
    public static final Datum RAT_LICENSE_FAMILY_NAME_DATUM_AFL_21 = new Datum(RAT_URL_LICENSE_FAMILY_NAME, RAT_LICENSE_FAMILY_NAME_VALUE_AFL_VERSION_2_1);
    public static final Datum RAT_LICENSE_FAMILY_NAME_DATUM_AFL_30 = new Datum(RAT_URL_LICENSE_FAMILY_NAME, RAT_LICENSE_FAMILY_NAME_VALUE_AFL_VERSION_3_0);
    public static final Datum RAT_LICENSE_FAMILY_NAME_DATUM_APSL_20 = new Datum(RAT_URL_LICENSE_FAMILY_NAME, RAT_LICENSE_FAMILY_NAME_VALUE_APSL_VERSION_2_0);
    public static final Datum RAT_LICENSE_FAMILY_NAME_DATUM_BSD_VERSION_2 = new Datum(RAT_URL_LICENSE_FAMILY_NAME, RAT_LICENSE_FAMILY_NAME_VALUE_BSD_VERSION_2);
    public static final Datum RAT_LICENSE_FAMILY_NAME_DATUM_BSD_VERSION_3 = new Datum(RAT_URL_LICENSE_FAMILY_NAME, RAT_LICENSE_FAMILY_NAME_VALUE_BSD_VERSION_3);
    public static final Datum RAT_LICENSE_FAMILY_NAME_DATUM_BSD_VERSION_4 = new Datum(RAT_URL_LICENSE_FAMILY_NAME, RAT_LICENSE_FAMILY_NAME_VALUE_BSD_VERSION_4);
    public static final Datum RAT_LICENSE_FAMILY_NAME_DATUM_PUBLIC_DOMAIN = new Datum(RAT_URL_LICENSE_FAMILY_NAME, RAT_LICENSE_FAMILY_NAME_VALUE_PUBLIC_DOMAIN);
    public static final Datum RAT_LICENSE_FAMILY_NAME_DATUM_EPL1 = new Datum(RAT_URL_LICENSE_FAMILY_NAME, RAT_LICENSE_FAMILY_NAME_VALUE_EPL1);
    public static final Datum RAT_LICENSE_FAMILY_NAME_DATUM_ZLIB = new Datum(RAT_URL_LICENSE_FAMILY_NAME, RAT_LICENSE_FAMILY_NAME_VALUE_ZLIB);
