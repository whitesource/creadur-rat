...
public class MetaData {
    ...
    public static final Datum RAT_LICENSE_FAMILY_NAME_DATUM_LGPL_VERSION_2_1
            = new Datum(RAT_URL_LICENSE_FAMILY_NAME, RAT_LICENSE_FAMILY_NAME_VALUE_LGPL_VERSION_2_1);
    public static final Datum RAT_LICENSE_FAMILY_NAME_DATUM_LGPL_VERSION_3
            = new Datum(RAT_URL_LICENSE_FAMILY_NAME, RAT_LICENSE_FAMILY_NAME_VALUE_LGPL_VERSION_3);
    public static final Datum RAT_LICENSE_FAMILY_NAME_DATUM_AGPL_VERSION_3
            = new Datum(RAT_URL_LICENSE_FAMILY_NAME, RAT_LICENSE_FAMILY_NAME_VALUE_AGPL_VERSION_3);
    public static final Datum RAT_LICENSE_FAMILY_NAME_DATUM_BSD_VERSION_2
            = new Datum(RAT_URL_LICENSE_FAMILY_NAME, RAT_LICENSE_FAMILY_NAME_VALUE_BSD_VERSION_2);
    public static final Datum RAT_LICENSE_FAMILY_NAME_DATUM_BSD_VERSION_3
            = new Datum(RAT_URL_LICENSE_FAMILY_NAME, RAT_LICENSE_FAMILY_NAME_VALUE_BSD_VERSION_3);
